...
const AccountStatement = () => {
  ...
  return (
    <div className="container mt-0">
      ...
      <h1 className="text-left title_h1">WBT Setting</h1>
      <section className="mb-4">
      <div className="d-flex justify-content-between">
        <Link to="/statement" className="btn btn-primary">Statement</Link>
        <Link to="/ac-operation" className="btn btn-primary">Account Operations</Link>
        <Link to="/profitLoss" className="btn btn-primary">Profit & Loss</Link>
        <Link to="/casinoDetails" className="btn btn-primary">Casino Profit & Loss</Link>
        <Link to="/changePasswordForm" className="btn btn-primary">Change Password</Link>
      </div>
    </section>
