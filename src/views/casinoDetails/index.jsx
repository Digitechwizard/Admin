...
const AccountStatement = () => {
  ...
  return (
    <div className="container mt-0">
      ...
      <h1 className="text-left title_h1">Diamond Casino Details</h1>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <div className="ml-2">
          <Link to="#" className="btn btn-primary" style={{ backgroundColor: '#ff1616', borderColor: '#ff1616', marginLeft: '10px' }}>Apply</Link>
          <Link to="#" className="btn btn-success ml-2" style={{ backgroundColor: '#28a745', borderColor: '#28a745', marginLeft: '10px' }}>Today P/L</Link>
        </div>
      </div>
