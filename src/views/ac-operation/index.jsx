...
const AccountStatement = () => {
  ...
  return (
    <div className="container mt-4">
      {/* Top Heading */}
      <h1 className="text-left mb-4">Statement</h1>
            ...
            {Object.keys(tableContents).map((tabKey) => (
              <li className="nav-item" key={tabKey}>
                <a
                  ...
                  href="#!"
                  onClick={(e) => { e.preventDefault(); handleTabChange(tabKey); }}
                >
                  {tabNames[tabKey]}
                </a>
              </li>
                        ...
                        <ul className="pagination justify-content-center mb-0">
                          ...
                          {Array.from({ length: totalPages }, (_, i) => (
                            <li className={`page-item ${currentPage === i + 1 ? 'active' : ''}`} key={i}>
                              <a className={`page-link ${currentPage === i + 1 ? 'active' : ''}`} href="#!" onClick={(e) => { e.preventDefault(); handlePageChange(i + 1); }}>
                                {i + 1}
                              </a>
                            </li>
                          ))}
