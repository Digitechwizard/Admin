...
const AccountStatement = () => {
  ...
  return (
    <div className="container mt-0">
      ...
      <h1 className="text-left title_h1">Client Limit Details</h1>
      ...
      <div className="mt-4">
        <div className="d-flex justify-content-center">
          <a href="clientMaster" className="btn btn-primary btn-lg w-100" style={{ backgroundColor: '#ff1616', borderColor: '#ff1616' }}>Back</a>
        </div>
      </div>
    </div>
  );
