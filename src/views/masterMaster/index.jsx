...
const AccountStatement = () => {
  ...
  return (
    <div className="container mt-0">
      ...
      <h1 className="text-left title_h1">Master Details</h1>

      {/* Buttons */}
      <div className="d-flex justify-content-between mb-3">
      <Link to="/createForm2" className="btn btn-primary" style={{ backgroundColor: '#ff1616', borderColor: '#ff1616' }}>+ Create</Link>
      <Link to="/updateLimit2" className="btn btn-success" style={{ backgroundColor: '#28a745', borderColor: '#28a745' }}>Update Limit</Link>
    </div>
